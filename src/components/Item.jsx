...
const Item = ({ id, nombre, precio, img, categoria }) => {
    ...
    return (
        <div className='flex flex-col items-center w-72 my-4'>
            ...
            <Link className='w-72 h-8 rounded-b-3xl text-center bg-black text-primary hover:bg-tertiary hover:text-black hover:font-semibold transition-all' to={`/item/${id}`}>Ver detalles</Link>
        </div>
    )
}
